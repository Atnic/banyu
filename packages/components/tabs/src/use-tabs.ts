import type {TabsVariantProps, SlotsToClasses, TabsSlots, TabsReturnType} from "@jala-banyu/theme";
...
import {CollectionProps} from "@jala-banyu/aria-utils";
import {CollectionChildren} from "@react-types/shared";
import {HTMLMotionProps} from "framer-motion";

export interface Props extends Omit<HTMLBanyuProps, "children"> {
  /**
   * Ref to the DOM node.
   */

...
import {accordionItem} from "@jala-banyu/theme";
import {clsx, callAllHandlers, dataAttr} from "@jala-banyu/shared-utils";
import {ReactRef, useDOMRef, filterDOMProps} from "@jala-banyu/react-utils";
import {NodeWithProps} from "@jala-banyu/aria-utils";
import {useReactAriaAccordionItem} from "@jala-banyu/use-aria-accordion";
...
export interface Props<T extends object> extends HTMLBanyuProps<"div"> {
  /**
   * Ref to the DOM node.
   */

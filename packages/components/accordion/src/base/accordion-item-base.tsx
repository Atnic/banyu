...
import {ItemProps, BaseItem} from "@jala-banyu/aria-utils";
...
export interface Props<T extends object = {}>
   ...
   * If you pass a function, Banyu will expose the current indicator and the open status,
   ...
   *    endContent: "end-indicator-classes",

import type {CheckboxGroupSlots, SlotsToClasses} from "@jala-banyu/theme";
...
import {checkboxGroup} from "@jala-banyu/theme";
...
export type UseCheckboxGroupProps = Props &
  ...
  Partial<
    Pick<
      CheckboxProps,
      "variant" | "color" | "size" | "radius" | "lineThrough" | "isDisabled" | "disableAnimation"
    >
  >;

import type {CheckboxVariantProps, CheckboxSlots, SlotsToClasses} from "@jala-banyu/theme";
...
import {__DEV__, warn, clsx, dataAttr, safeAriaLabel} from "@jala-banyu/shared-utils";
import {
...
interface Props extends Omit<HTMLBanyuProps<"input">, keyof CheckboxVariantProps> {
  /**
   * Ref to the DOM node.
   */
...
export function useCheckbox(props: UseCheckboxProps = {}) {
  ...
  const slots = useMemo(
    ...
    [variant, color, size, radius, isInvalid, lineThrough, isDisabled, disableAnimation],
  );

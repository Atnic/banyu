import type {ListboxItemVariantProps, ListboxItemSlots, SlotsToClasses} from "@jala-banyu/theme";
...
interface Props<T extends object = {}> extends Omit<ItemProps<"li", T>, "children" | "title"> {
   ...
   * If you pass a function, Banyu will expose the current selected icon and the selected status,

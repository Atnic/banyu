...
import {popover, ButtonVariantProps} from "@jala-banyu/theme";
import {Button} from "@jala-banyu/button";
import {Card, CardHeader, CardFooter} from "@jala-banyu/card";
      ...
      {(titleProps) => (
        <div className="px-1 py-2 w-full">
          ...
          <div className="mt-2 flex flex-col gap-2 w-full">
            <Input autoFocus defaultValue="100%" label="Width" size="sm" variant="flat" />
            <Input defaultValue="300px" label="Max. width" size="sm" variant="flat" />
            <Input defaultValue="24px" label="Height" size="sm" variant="flat" />
            <Input defaultValue="30px" label="Max. height" size="sm" variant="flat" />
          </div>
        </div>
      )}
    </PopoverContent>
    ...
    <PopoverContent className="w-[240px]">
      {(titleProps) => (
        <div className="px-1 py-2 w-full">
          ...
          <div className="mt-2 flex flex-col gap-2 w-full">
            <Input defaultValue="100%" label="Width" size="sm" variant="flat" />
            <Input defaultValue="300px" label="Max. width" size="sm" variant="flat" />
            <Input defaultValue="24px" label="Height" size="sm" variant="flat" />
            <Input defaultValue="30px" label="Max. height" size="sm" variant="flat" />
          </div>

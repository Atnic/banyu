import type {PaginationSlots, PaginationVariantProps, SlotsToClasses} from "@jala-banyu/theme";
import type {Timer} from "@jala-banyu/shared-utils";
...
import {
  ...
  PaginationItemValue,
  PaginationItemType,
} from "@jala-banyu/use-pagination";
import {useEffect, useRef, useMemo} from "react";
import {mapPropsVariants} from "@jala-banyu/system";
import {usePagination as useBasePagination} from "@jala-banyu/use-pagination";
import scrollIntoView from "scroll-into-view-if-needed";
import {pagination} from "@jala-banyu/theme";

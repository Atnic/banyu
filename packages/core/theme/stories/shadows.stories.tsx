...
const ShadowContainer = ({title, desc, component}:ShadowsProps) => (
    <div className="">
        <div className="border-b-2 pb-4">
            ...
            <pre className="text-xs text-gray-400 text-wrap">
                {desc}
            </pre>
        </div>
...
const BoxShadow = () => (
    <div className="my-2 not-prose relative bg-slate-50 rounded-xl overflow-hidden"><div className="absolute inset-0 bg-grid-slate-100 [mask-image:linear-gradient(0deg,#fff,rgba(255,255,255,0.6))]" style={{"backgroundPosition": "10px 10px"}}></div><div className="relative rounded-xl overflow-auto p-8"><div className="flex items-center justify-around gap-4 font-mono font-bold">
                <div className="flex flex-col gap-4 items-center">
                    <div className="w-24 h-24 rounded-lg bg-white shadow-sm"></div>
                    <span className="text-sm">.shadow-sm</span>
                </div>
                <div className="flex flex-col gap-4 items-center">
                    <div className="w-24 h-24 rounded-lg bg-white shadow"></div>
                ...
                <div className="flex flex-col gap-4 items-center">
                    <div className="w-24 h-24 rounded-lg bg-white shadow-inner"></div>
                    <span className="text-sm">.shadow-inner</span>
                </div>
</div></div><div className="absolute inset-0 pointer-events-none border border-black/5 rounded-xl"></div></div>
)
const DropShadow = () =>(
